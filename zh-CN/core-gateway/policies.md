...
![Create Policy 抽屉——名称、描述，以及各能力选择器](/assets/images/policies/create-policy-drawer.png)
...
- 策略详情页会把它列在 `dangling`（失效）下，并显示警告。
